...
| [Introduction to Rx](http://www.introtorx.com)                                                               | Ian Griffiths                                                | HTML                   |
...
| [Essential C++](https://www.programming-books.io/essential/cpp/)                                                              | Krzysztof Kowalczyk, StackOverflow Contributors | HTML             |
...
| [Let's learn Go!](http://go-book.readthedocs.io/en/latest/)    |                 Big Yuuta                  | HTML                               |
...
| [CSS Transition vs CSS animation](https://www.freecodecamp.org/news/css-transition-vs-css-animation-handbook/) | Oluwatobi Sofela                 | HTML                            |
...
| [Dive into Python](https://linux.die.net/diveintopython/html/toc/index.html)                                   | Mark Pilgrim                                                                                                                                       | HTML (2.3)                                    |
...
| [Introduction to Programming with Python](http://opentechschool.github.io/python-beginners/en/)          | -                                                                                                                                                  | HTML (3.3)                                      |
...
| [Python 3 Official Documentation](https://docs.python.org/3/download.html)                                      | -                                                                                                                                                  | PDF, EPUB, HTML, TEXT                 |
...
| [Python Practice Book](http://anandology.com/python-practice-book/index.html)                                   | -                                                                                                                                                  | HTML (2.7.1)                                  |
...
| [The Definitive Guide to Jython, Python for the Java Platform](https://jython.readthedocs.io/en/latest/)       | Josh Juneau, Jim Baker, Victor Ng, Leo Soto, Frank Wierzbicki                                                                                      | HTML (2.5)                                    |
| [The Hitchhiker's Guide to Python: Best Practices for Development](https://docs.python-guide.org)               | Kenneth Reitz, Tanya Schlusser, et al                                                                                                              | HTML                                      |
| [The Little Book of Python Anti-Patterns](http://docs.quantifiedcode.com/python-anti-patterns/)                | ([GitHub Source](https://github.com/quantifiedcode/python-anti-patterns))                                                                                 | HTML                                      |
| [The Programming Historian](http://niche-canada.org/research/niche-digital-infrastructure-project/the-programming-historian/) | William J. Turkel, Adam Crymble and Alan MacEachern                                                                                               | HTML                                      |
| [The Python Coding Book](https://thepythoncodingbook.com)                                                       | Stephen Gruppetta                                                                                                                                  | HTML                                   |
| [The Python GTK+ 3 Tutorial](http://python-gtk-3-tutorial.readthedocs.org/en/latest/)                          | -                                                                                                                                                  | HTML                                      |
| [The Python Handbook](https://flaviocopes.com/page/python-handbook/)                                            | Flavio Copes                                                                                                                                       | PDF, EPUB, Kindle *(Email requested.)* |
| [The Recursive Book of Recursion](https://inventwithpython.com/recursion/)                                      | Al Swigart                                                                                                                                         | HTML (3.x)                             |
| [The Standard Python Library](https://web.archive.org/web/20200626001242/http://effbot.org/librarybook/)       | Fredrik Lundh                                                                                                                                      | HTML                                      |
| [Think Complexity](https://greenteapress.com/wp/think-complexity-2e/)                                          | Allen B. Downey                                                                                                                                    | PDF, HTML                              |
| [Think DSP - Digital Signal Processing in Python](https://greenteapress.com/wp/think-dsp/)                      | Allen B. Downey                                                                                                                                    | PDF, HTML                              |
| [Think Python 2nd Edition](https://greenteapress.com/wp/think-python-2e/)                                       | Allen B. Downey                                                                                                                                    | HTML, PDF                              |
| [Think Python First Edition](https://greenteapress.com/wp/think-python/)                                        | Allen B. Downey                                                                                                                                    | HTML, PDF                              |
| [Tiny Python 3.6 Notebook](https://github.com/mattharrison/Tiny-Python-3.6-Notebook)                          | Matt Harrison                                                                              | HTML (3.6)              |
| [Tiny Python Projects](http://tinypythonprojects.com/Tiny_Python_Projects.pdf)                                | Ken Youens-Clark                                                                           | PDF              |
| [Web2py: Complete Reference Manual, 6th Edition (pre-release)](http://web2py.com/book)                        | -                                                                                          | HTML (2.5 - 2.x)        |

### Django

| Title                                                                                                         | Author                                                                                  | Format |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|--------|
| [All-Auth](https://django-allauth.readthedocs.io/en/latest/overview.html)                                    | Django Docs                                                                                       | HTML   |
| [AutoComplete-Light](https://django-autocomplete-light.readthedocs.io/en/master/tutorial.html)               | Django Docs                                                                                       | HTML   |
| [Django Filters](https://django-filter.readthedocs.io/en/stable/)                                             | Django Docs                                                                                       | HTML   |
| [Django Girls Tutorial](https://tutorial.djangogirls.org/en/)                                                 | Django Docs                                                                                       | HTML (1.11)   |
| [Django Official Documentation](https://buildmedia.readthedocs.org/media/pdf/django/4.1.x/django.pdf)        | Django                                                                                       | PDF (4.1.x)    |
...
| [Django RESTful Web Services](https://www.packtpub.com/free-ebooks/django-restful-web-services)               | Gaston C. Hillar                                           | HTML (Packt account *required*)      |
| [Django Storages](https://django-storages.readthedocs.io/en/latest/)                                           | Django                                                                                       | HTML   |
| [Django Tinymce](https://django-tinymce.readthedocs.io/en/latest/)                                           | Django                                                                                       | HTML   |
| [Django Web Framework (Python)](https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django)          | MDN contributors                                                                        | HTML     |
| [Djen of Django](http://agiliq.com/books/djenofdjango/)                                                       | Agiliq                                                                                       | HTML      |
| [Effective Django](https://web.archive.org/web/20181130092020/http://www.effectivedjango.com/)                | Nathan Yergler                                                                                       | HTML (1.5)    |
| [How to Tango With Django](http://www.tangowithdjango.com/book17/)                                             | Leif Azzopardi, David Maxwell                                                                                       | HTML (1.7)    |
| [Social Auth App](https://python-social-auth.readthedocs.io/en/latest/)                                       | Matías Aguirre                                                                                       | HTML   |
| [Test-Driven Development With Python And Django](http://www.obeythetestinggoat.com/pages/book.html)          | Harry J.W. Percival                                                                                       | HTML (1.11)   |

### Flask

| Title                                                                                                         | Author        | Format    |
|----------------------------------------------------------------------------------------------------------------|---------------|-----------|
| [Explore Flask](https://exploreflask.com)                                                                    | Robert Picard | HTML         |
| [Flask Documentation](https://flask.palletsprojects.com)                                                      | Pallets       | HTML         |
| [Python Flask Tutorial](https://www.tutorialspoint.com/flask/)                                                | Tutorials Point | HTML, PDF |
| [The Flask Mega-Tutorial](http://blog.miguelgrinberg.com/post/the-flask-mega-tutorial-part-i-hello-world)   | Miguel Grinberg | HTML (0.9)       |
...
| Title                                                                                                         | Author                                                                                  | Format |
|---------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|--------|
| [Advanced R Programming](http://adv-r.had.co.nz)                                                              | Hadley Wickham                                                                          | HTML      |
| [An Introduction to ggplot2](https://bookdown.org/ozancanozdemir/introduction-to-ggplot2)                    | Ozancan Ozdemir                                                                         | HTML      |
| [An Introduction to R](https://cran.r-project.org/doc/manuals/R-intro.html)                                   | David M. Smith, William N. Venables                                                     | HTML      |
...
| [Beyond Multiple Linear Regression](https://bookdown.org/roback/bookdown-BeyondMLR)                           | Paul Roback, Julie Legler                                                               | HTML      |
| [blogdown: Creating Websites with R Markdown](https://bookdown.org/yihui/blogdown/)                           | Yihui Xie, Amber Thomas, Alison Presmanes Hill                                          | HTML      |
| [Cookbook for R](http://www.cookbook-r.com)                                                                   | Winston Chang                                                                           | HTML      |
| [Data Analysis and Prediction Algorithms with R](https://rafalab.github.io/dsbook/)                            | Rafael A. Irizarry                                                                       | HTML      |
| [Data Mining Algorithms In R](https://en.wikibooks.org/wiki/Data_Mining_Algorithms_In_R)                     | Wikibooks                                                                               | HTML      |
| [Data Visualization with R](https://ladal.edu.au/dviz.html)                                                   | Martin Schweinberger                                                                     | HTML   |
| [Efficient R programming](https://csgillespie.github.io/efficientR/)                                          | Colin Gillespie, Robin Lovelace                                                         | HTML      |
| [Exploratory Data Analysis with R](https://bookdown.org/rdpeng/exdata)                                         | Roger D. Peng                                                                            | HTML      |
| [Forecasting: Principles and Practice](https://otexts.com/fpp3/)                                                | Rob J Hyndman, George Athanasopoulos                                                     | HTML      |
| [Functional Programming](https://dcl-prog.stanford.edu)                                                        | Sara Altman, Bill Behrman, Hadley Wickham                                                | HTML      |
| [Geocomputation with R](https://r.geocompx.org)                                                               | Robin Lovelace, Jakub Nowosad, Jannes Muenchow                                           | HTML      |
| [Introduction to Probability and Statistics Using R](https://github.com/gjkerns/IPSUR)                        | G. Jay Kerns                                                                             | PDF    |
| [Learning Statistics with R](https://learningstatisticswithr.com/book/)                                         | Danielle Navarro                                                                         | HTML      |
| [Mastering Software Development in R](https://bookdown.org/rdpeng/RProgDA/)                                    | Roger D. Peng, Sean Kross, and Brooke Anderson                                            | HTML      |
| [Model Estimation by Example, Demonstrations with R](https://m-clark.github.io/models-by-example)             | Michael Clark                                                                            | HTML      |
| [Modern R with the tidyverse](https://b-rodrigues.github.io/modern_R)                                          | Bruno Rodrigues                                                                          | HTML      |
| [Modern Statistics with R](https://www.modernstatisticswithr.com)                                              | Måns Thulin                                                                              | HTML      |
| [ModernDive](https://ismayc.github.io/moderndiver-book/)                                                       | Chester Ismay, Albert Y. Kim                                                            | HTML      |
| [Practical Regression and Anova using R](http://cran.r-project.org/doc/contrib/Faraway-PRA.pdf)               | Julian J. Faraway                                                                        | PDF    |
| [R for Data Science](https://r4ds.hadley.nz)                                                                   | Hadley Wickham, Mine Çetinkaya-Rundel, Garrett Grolemund                                 | HTML      |
| [R for Spatial Analysis](http://www.columbia.edu/~cjd11/charles_dimaggio/DIRE/resources/spatialEpiBook.pdf) | Charles Dimaggio                                                                                       | PDF    |
| [R Language for Programmers](http://www.johndcook.com/blog/r_language_for_programmers)                        | John D. Cook                                                                             | HTML      |
| [R Notes for Professionals](https://goalkicker.com/RBook/)                                                     | Compiled from StackOverflow Documentation                                                | PDF    |
| [R Packages](https://r-pkgs.org)                                                                              | Hadley Wickham, Jenny Bryan                                                              | HTML      |
| [R Practicals](http://www.columbia.edu/~cjd11/charles_dimaggio/DIRE/resources/R/practicalsBookNoAns.pdf)     | Charles Dimaggio                                                                                       | PDF    |
| [R Programming](https://en.wikibooks.org/wiki/R_Programming)                                                   | Wikibooks                                                                               | HTML      |
| [R Programming for Data Science](https://bookdown.org/rdpeng/rprogdatascience/)                                | Roger D. Peng                                                                            | HTML      |
| [R Succinctly](https://www.syncfusion.com/resources/techportal/ebooks/rsuccinctly)               | Barton Poulson                                                                                       | PDF, Kindle |
| [Statistical Inference via Data Science](https://moderndive.com)                                                | Chester Ismay, Albert Y. Kim                                                            | HTML      |
| [Summary and Analysis of Extension Program Evaluation in R](https://rcompanion.org/handbook/index.html)        | Salvatore S. Mangiafico                                                                  | HTML      |
| [Supervised Machine Learning for Text Analysis in R](https://smltar.com)                                        | Emil Hvitfeldt, Julia Silge                                                              | HTML      |
| [The caret Package](http://topepo.github.io/caret/index.html)                                                  | Max Kuhn                                                                                 | HTML      |
| [The R Inferno](http://www.burns-stat.com/pages/Tutor/R_inferno.pdf)                                           | Patrick Burns                                                                            | PDF    |
| [The R Language](http://stat.ethz.ch/R-manual/R-patched/doc/html)                                              | -                                                                                       | HTML      |
| [The R Manuals](http://cran.r-project.org/manuals.html)                                                        | R Development Core Team                                                                                       | HTML      |
| [Tidy Modelling with R](https://www.tmwr.org)                                                                  | Max Kuhn and Julia Silge                                                                 | HTML      |
| [Tidy Text Mining with R](http://tidytextmining.com)                                                           | Julia Silge, David Robinson                                                              | HTML      |
...
| [Just Enough Ruby to Get By](http://jasonkim.ca/projects/just_enough_ruby_to_get_by/)                | Jason Kim                                              | HTML      |
...
| [Mr. Neighborly's Humble Little Ruby Book](https://web.archive.org/web/20180321101922/http://www.humblelittlerubybook.com/book/html/index.html) | - | HTML |
| [Object Oriented Programming with Ruby](https://launchschool.com/books/oo_ruby)                       | Launch School                                  | HTML      |
| [Practicing Ruby](https://github.com/elm-city-craftworks/practicing-ruby-manuscripts)                 | Gregory Brown                                              | HTML      |
...
| [Ruby Learning](http://rubylearning.github.io)                                                         | Satish Talim                                              | HTML      |
...
| [Ruby User's Guide](https://ruby-doc.org/docs/ruby-doc-bundle/UsersGuide/rg/index.html)                | matz                                              | HTML      |
| [Ruby Web Dev: The Other Way](https://leanpub.com/rwdtow/read)                                         | Yevhen Kuzminov                                | HTML      |
| [Rubyfu](https://rubyfu.net)                                                                           | Sabri Hassanyah                                              | HTML      |
| [The Bastards Book of Ruby](http://ruby.bastardsbook.com)                                              |  Dan Nguyen                                              | HTML      |
...
| Title                                                                                                 | Author                        | Format |
|-------------------------------------------------------------------------------------------------------|-------------------------------|--------|
| [Api on Rails 6](https://github.com/madeindjs/api_on_rails)                                          | Alexandre Rousseau           | HTML      |
| [Building REST APIs with Rails](https://www.softcover.io/read/06acc071/api_on_rails)                 | Abraham Kuri Vargas           | HTML      |
| [Essential Ruby on Rails](https://www.programming-books.io/essential/rubyonrails/)                    | Krzysztof Kowalczyk, StackOverflow Contributors | HTML |
| [Kestrels, Quirky Birds, and Hopeless Egocentricity](https://leanpub.com/combinators/read)            | Reg Braithwaite               | HTML      |
| [Learn Ruby on Rails: Book One](https://learn-rails.com/content/learnrails1)                           | Daniel Kehoe                  |HTML      |
| [Learn Ruby on Rails: Book Two](https://learn-rails.com/content/learnrails2)                       | Daniel Kehoe                  | HTML     |
| [Objects on Rails](https://web.archive.org/web/20190319201525/http://objectsonrails.com/)          | Avdi Grimm                    | HTML     |
| [Rails Style Guide](https://rails.rubystyle.guide)                                                  | Bozhidar Batsov               | HTML     |
| [Ruby Notes for Professionals](https://books.goalkicker.com/RubyBook/)                              | Compiled from StackOverflow Documentation | PDF |
| [Ruby on Rails Guides](http://guides.rubyonrails.org)                                               | -                             | HTML     |
| [Ruby on Rails Notes for Professionals](https://goalkicker.com/RubyOnRailsBook/)                    | Compiled from StackOverflow Documentation | PDF |
| [Ruby on Rails Tutorial (Rails 5): Learn Web Development with Rails](https://www.railstutorial.org/book) | [Michael Hartl](http://www.michaelhartl.com) | HTML |
...
| [Rust for Rubyists](https://web.archive.org/web/20190520171322/http://www.rustforrubyists.com/book) | Steve Klabnik                   | HTML      |
| [Rust For Systems Programmers](https://github.com/nrc/r4cppp)                              | Nick Cameron                                | HTML      |
| [The Embedded Rust Book](https://docs.rust-embedded.org/book/intro/index.html)             | Rust Docs                                           | HTML      |
| [The Little Book of Rust Macros](https://danielkeep.github.io/tlborm/book)                 | Rust Docs                                           | HTML      |
| [The Rust Language Reference](https://github.com/rust-lang/reference)                      | Rust Docs                                           | HTML      |
| [The Rust Performance Book](https://nnethercote.github.io/perf-book)                        | Rust Docs                                           | HTML      |
| [The Rust Programming Language](http://doc.rust-lang.org/book)                              | Steve Klabnik, Carol Nichols, et al.       | HTML   |
| [The Rust RFC Book](https://rust-lang.github.io/rfcs)                                       | Rust Docs                                           | HTML      |
| [The Rustc Book](https://doc.rust-lang.org/rustc)                                           | Rust Docs                                           | HTML      |
| [The Rustonomicon](https://doc.rust-lang.org/nomicon)                                        | Rust Docs                                           | HTML      |
| [Why Rust?](https://www.oreilly.com/content/why-rust)                                       | Sean Murphy                                           | HTML      |
...
| Title                                                                                     | Author                                      | Format |
|-------------------------------------------------------------------------------------------|---------------------------------------------|--------|
| [Essential Swift](https://www.programming-books.io/essential/swift/)                      | Krzysztof Kowalczyk (Compiled from StackOverflow Documentation) | HTML      |
...
| [The Swift Programming Language](https://docs.swift.org/swift-book/LanguageGuide/TheBasics.html) | Swift Docs                                       | HTML   |
...
| [TypeScript Notes for Professionals](https://goalkicker.com/TypeScriptBook2/)                     | Compiled from StackOverflow documentation | PDF    |
| [TypeScript Succinctly](https://www.syncfusion.com/resources/techportal/ebooks/typescript)       | Steve Fenton                                          | HTML, PDF, Kindle |
...
| [Vulkan Tutorial Java](https://github.com/Naitsirc98/Vulkan-Tutorial-Java)                           | Cristian Herrera, et al.        | Java (GitHub)   |
| [Vulkan Tutorial RS](https://github.com/bwasty/vulkan-tutorial-rs)                                    | Benjamin Wasty, et al.          | Rust (GitHub)   |
...
| Title | Author | Format |
|-------|--------|--------|
| [A Field Guide To Genetic Programming](https://web.archive.org/web/20191020195105/http://www0.cs.ucl.ac.uk/staff/W.Langdon/ftp/papers/poli08_fieldguide.pdf) | Riccardo Poli, William B. Langdon, Nicholas F. McPhee | PDF |
...
| [Algorithmic Thinking](https://labuladong.gitbook.io/algo-en) | Donglai Fu | HTML |
| [Algorithms](https://en.wikibooks.org/wiki/Algorithms) | Wikibooks | HTML |
| [Algorithms](https://jeffe.cs.illinois.edu/teaching/algorithms/book/Algorithms-JeffE.pdf) | Jeff Erickson | PDF |
| [Algorithms, 4th Edition](https://algs4.cs.princeton.edu/home/) | Robert Sedgewick, Kevin Wayne | HTML |
| [Algorithms and Automatic Computing Machines (1963)](https://archive.org/details/Algorithms_And_Automatic_Computing_Machines) | B. A. Trakhtenbrot | HTML |
...
| [Algorithms Course Materials](https://jeffe.cs.illinois.edu/teaching/algorithms/) | Jeff Erickson | HTML |
| [Algorithms Notes for Professionals](https://goalkicker.com/AlgorithmsBook) | Compiled from StackOverflow Documentation | PDF |
| [Annotated Algorithms in Python: Applications in Physics, Biology, and Finance](https://github.com/mdipierro/nlib) | Massimo Di Pierro | HTML |
...
| [Data Structures](https://en.wikibooks.org/wiki/Data_Structures) | Wikibooks | HTML |
...
| [Data Structures Succinctly Part 1, Syncfusion](https://www.syncfusion.com/resources/techportal/ebooks/datastructurespart1) | Robert Horvick | HTML |
| [Data Structures Succinctly Part 2, Syncfusion](https://www.syncfusion.com/resources/techportal/ebooks/datastructurespart2) | Robert Horvick | HTML |
| [Elementary Algorithms](https://github.com/liuxinyu95/AlgoXY) | Larry Liu Xinyu | PDF |
| [Essential Algorithms](https://www.programming-books.io/essential/algorithms/) | Krzysztof Kowalczyk, Stack Overflow Documentation project | HTML |
| [Foundations of Computer Science](http://infolab.stanford.edu/~ullman/focs.html) | Al Aho, Jeff Ullman | HTML |
...
| [LEDA: A Platform for Combinatorial and Geometric Computing](https://people.mpi-inf.mpg.de/~mehlhorn/LEDAbook.html) | K. Mehlhorn, St. Näher | HTML |
...
| [Open Data Structures: An Introduction](https://opendatastructures.org) | Pat Morin | HTML |
| [Planning Algorithms](http://lavalle.pl/planning/) | Steven M. LaValle | HTML |
...
| [The Algorithms](https://the-algorithms.com) | - | HTML |
...
| [The Kademlia Protocol Succinctly](https://www.syncfusion.com/ebooks/kademlia_protocol_succinctly) | Marc Clifton | HTML |
| [Think Complexity (2nd Edition)](https://greenteapress.com/wp/think-complexity-2e/) | Allen B. Downey | HTML |
...
| [Data Mining Algorithms In R](https://en.wikibooks.org/wiki/Data_Mining_Algorithms_In_R) | Wikibooks | HTML |
| [Data Mining Concepts and Techniques](https://ia800702.us.archive.org/7/items/datamining_201811/DS-book%20u5.pdf) | Jiawei Han, Micheline Kamber, Jian Pei | PDF |
| [Data Science at the Command Line](https://datascienceatthecommandline.com/2e/) | Jeroen Janssens | HTML |
| [Elements of Data Science](https://allendowney.github.io/ElementsOfDataScience/README.html) | Allen B. Downey | HTML |
| [Feature Engineering and Selection: A Practical Approach for Predictive Models](https://bookdown.org/max/FES/) | Max Kuhn, Kjell Johnson | HTML |
...
| [Internet Advertising: An Interplay among Advertisers, Online Publishers, Ad Exchanges and Web Users](https://arxiv.org/pdf/1206.1754v2.pdf) | Shuai Yuan, Ahmad Zainal Abidin, Marc Sloan, Jun Wang | PDF |
| [Introduction to Cultural Analytics & Python](https://melaniewalsh.github.io/Intro-Cultural-Analytics/welcome.html) | Melanie Walsh | HTML |
| [Introduction to Data Science](https://docs.google.com/file/d/0B6iefdnF22XQeVZDSkxjZ0Z5VUE/edit?pli=1) | Jeffrey Stanton | PDF  |
...
| [Probability and Statistics with Examples using R](https://www.isibang.ac.in/~athreya/psweur/index.html#usage) | Siva Athreya, Deepayan Sarkar, Steve Tanner | HTML  |
| [Statistical inference for data science](https://leanpub.com/LittleInferenceBook/read) | Brian Caffo | HTML |
| [The Ultimate Guide to 12 Dimensionality Reduction Techniques (with Python codes)](https://www.analyticsvidhya.com/blog/2018/08/dimensionality-reduction-techniques-python/) | Pulkit Sharma | HTML |
...
| Title | Author | Format |
|-------|--------|--------|
| [Database Design – 2nd Edition](https://opentextbc.ca/dbdesign01/) | Adrienne Watt, Nelson Eng | HTML, PDF, EPUB, Kindle |
...
| [Foundations of Databases](http://webdam.inria.fr/Alice/) |  Alisson Wesley | HTML |
| [Readings in Database Systems, 5th Ed.](http://www.redbook.io) | Peter Bailis, Joseph M. Hellerstein, Michael Stonebraker | HTML |
| [Temporal Database Management](https://people.cs.aau.dk/~csj/Thesis/) | Christian S. Jensen | HTML |
| [The Theory of Relational Databases](https://web.cecs.pdx.edu/~maier/TheoryBook/TRD.html) | David Maier | HTML |
...
| Title | Author | Format |
|-------|--------|--------|
| [2D Game Development: From Zero To Hero](https://github.com/Penaz91/2DGD_F0TH) | Daniele Penazzo | HTML, [PDF, EBPUB, Kindle](https://therealpenaz91.itch.io/2dgd-f0th#download) |
| [3D Math Primer for Graphics and Game Development](https://gamemath.com/book/intro.html) | Fletcher Dunn | HTML |
| [Coding With Minecraft](https://turtleappstore.com/book/) | Al Sweigart | HTML |
| [Designing Virtual Worlds](https://mud.co.uk/richard/DesigningVirtualWorlds.pdf) | Richard A. Bartle | PDF |
| [Game AI Pro](https://www.gameaipro.com) | Steve Rabin | HTML |
| [Game Design with AGS](https://ensadi.github.io/AGSBook/) | Dave Ensminger, A. G. Madi | HTML |
| [Game Programming Patterns](https://gameprogrammingpatterns.com) | Bob Nystrom | HTML |
...
| [Procedural Content Generation in Games](https://pcgbook.com) | Noor Shaker, Julian Togelius, Mark Nelson | HTML |
...
| [A Brief Introduction to Neural Networks](https://www.dkriesel.com/en/science/neural_networks) | D. Kriesel | HTML |
...
| [A Course in Machine Learning](http://ciml.info/dl/v0_9/ciml-v0_9-all.pdf) | Hal Daumé III | PDF |
| [A First Encounter with Machine Learning](https://web.archive.org/web/20210420163002/https://www.ics.uci.edu/~welling/teaching/ICS273Afall11/IntroMLBook.pdf) | Max Welling | PDF |
...
| [An Introduction to Statistical Learning](https://www.statlearning.com) | Gareth James, Daniela Witten, Trevor Hastie, Robert Tibshirani | HTML |
| [Approaching Almost Any Machine Learning Problem](https://github.com/abhishekkrthakur/approachingalmost) | Abhishek Thakur | PDF |
| [Bayesian Reasoning and Machine Learning](http://web4.cs.ucl.ac.uk/staff/D.Barber/pmwiki/pmwiki.php?n=Brml.HomePage) | David J.C. MacKay | HTML |
| [Deep Learning](https://www.deeplearningbook.org) | Ian Goodfellow, Yoshua Bengio, Aaron Courville | HTML |
...
| [Dive into Deep Learning](https://d2l.ai) | - | HTML |
| [Explorations in Parallel Distributed Processing: A Handbook of Models, Programs, and Exercises](https://web.stanford.edu/group/pdplab/pdphandbook) | James L. McClelland | HTML |
| [Foundations of Machine Learning, Second Edition](https://mitpress.ublish.com/ebook/foundations-of-machine-learning--2-preview/7093/Cover) | Mehryar Mohri, Afshin Rostamizadeh, Ameet Talwalkar | HTML |
| [Free and Open Machine Learning](https://nocomplexity.com/documents/fossml/) | Maikel Mardjan | HTML |
| [Gaussian Processes for Machine Learning](https://www.gaussianprocess.org/gpml/) | Carl Edward Rasmussen, Christopher K.I. Williams | HTML |
| [IBM Machine Learning for Dummies](https://www.ibm.com/downloads/cas/GB8ZMQZ3) | Judith Hurwitz, Daniel Kirsch | HTML |
| [Information Theory, Inference, and Learning Algorithms](http://www.inference.phy.cam.ac.uk/itila/) | David J.C. MacKay | HTML |
| [Interpretable Machine Learning](https://christophm.github.io/interpretable-ml-book/) | Christoph Molnar | HTML |
| [Introduction to CNTK Succinctly](https://www.syncfusion.com/ebooks/cntk_succinctly) | James McCaffrey | HTML |
| [Introduction to Machine Learning](https://arxiv.org/abs/0904.3664v1) | Amnon Shashua | HTML |
| [Keras Succinctly](https://www.syncfusion.com/ebooks/keras-succinctly) | James McCaffrey | HTML |
| [Learn Tensorflow](https://bitbucket.org/hrojas/learn-tensorflow) | Hernan Rojas | Jupyter Notebooks |
| [Learning Deep Architectures for AI](https://mila.quebec/wp-content/uploads/2019/08/TR1312.pdf) | Yoshua Bengio | PDF |
| [Machine Learning](https://www.intechopen.com/books/machine_learning) | Abdelhamid Mellouk, Abdennasser Chebira | HTML |
| [Machine Learning for Beginners](https://github.com/Microsoft/ML-For-Beginners) | Microsoft | HTML |
| [Machine Learning for Data Streams](https://moa.cms.waikato.ac.nz/book-html/) | Albert Bifet, Ricard Gavaldà, Geoff Holmes, Bernhard Pfahringer | HTML |
| [Machine Learning from Scratch](https://dafriedman97.github.io/mlbook/) | Danny Friedman | HTML, PDF, Jupyter Book |
| [Machine Learning, Neural and Statistical Classification](https://www1.maths.leeds.ac.uk/~charles/statlog/) | D. Michie, D.J. Spiegelhalter, C.C. Taylor | HTML |
| [Machine Learning Simplified](https://themlsbook.com/read) | Andrew Wolf | HTML |
...
| [Mathematics for Machine Learning](https://mml-book.github.io) | Marc Peter Deisenroth, A Aldo Faisal, Cheng Soon Ong | HTML |
...
| [Neural Networks and Deep Learning](http://neuralnetworksanddeeplearning.com) | Michael Nielsen | HTML |
...
| [The Elements of Statistical Learning](https://web.stanford.edu/~hastie/ElemStatLearn/) | Trevor Hastie, Robert Tibshirani, and Jerome Friedman | HTML |
...
| [The Mathematical Engineering of Deep Learning](https://deeplearningmath.org) | Benoit Liquet, Sarat Moka, Yoni Nazarathy | HTML |
| [The Mechanics of Machine Learning](https://mlbook.explained.ai) | Terence Parr, Jeremy Howard | HTML |
| [The Python Game Book](https://web.archive.org/web/20210308080726/https://thepythongamebook.com/en%3Astart) | Horst Jens | PDF |
| [Top 10 Machine Learning Algorithms Every Engineer Should Know](https://www.dezyre.com/article/top-10-machine-learning-algorithms/202) | Binny Mathews, Omair Aasim | HTML |
...
| [Introduction to Computer Science](https://www.cse.iitd.ernet.in/~suban/CSL102/) | Subhashis Banerjee, IIT Delhi | HTML |
| [Introduction to Computing](https://www.computingbook.org) | David Evans | HTML |
| [Principled Programming / Introduction to Coding in Any Imperative Language](https://www.cs.cornell.edu/info/people/tt/Principled_Programming.html) | Tim Teitelbaum | HTML |
| [Programming and Programming Languages](https://papl.cs.brown.edu/2019/) | Shriram Krishnamurthi | HTML |
| [Programming Languages: Application and Interpretation (2nd Edition)](https://cs.brown.edu/~sk/Publications/Books/ProgLangs/) | Shriram Krishnamurthi | HTML |
...
| [The Black Art of Programming](http://self.gutenberg.org/wplbn0002828847-the-black-art-of-programming-by-mcilroy-mark.aspx?) | Mark McIlroy | HTML |
| [The Craft of Programming](https://kilthub.cmu.edu/articles/The_Craft_of_Programming/6610514) | John C. Reynolds | HTML |
...
| [Agile Planning: From Ideas to Story Cards](https://launchschool.com/books/agile_planning) | Launch School | HTML |
| [Architectural Styles and the Design of Network-based Software Architectures](https://www.ics.uci.edu/~fielding/pubs/dissertation/top.htm) | Roy Thomas Fielding | HTML |
| [Best Kept Secrets of Peer Code Review](https://smartbear.com/lp/ebook/collaborator/secrets-of-peer-code-review/) | - | HTML |
...
| [Data-Oriented Design](https://www.dataorienteddesign.com/dodmain/dodmain.html) | Richard Fabian | HTML |
...
| [Domain-Driven Design Reference](https://www.domainlanguage.com/ddd/reference) | Eric Evans | HTML |
| [DSL Engineering: Designing, Implementing and Using Domain-Specific Languages](http://dslbook.org) | Markus Voelter | HTML |
...
| [How to Design Programs](https://www.htdp.org) | - | HTML |
| [How to Write Unmaintainable Code](https://mindprod.com/jgloss/unmain.html) | - | HTML |
| [Kanban and Scrum - making the most of both](https://www.infoq.com/minibooks/kanban-scrum-minibook) | - | HTML |
| [Microservices AntiPatterns and Pitfalls](http://web.archive.org/web/20210205164251/https://www.oreilly.com/programming/free/files/microservices-antipatterns-and-pitfalls.pdf) | Mark Richards | PDF  |
...
| [Object-Oriented Reengineering Patterns](https://scg.unibe.ch/download/oorp/) | S. Demeyer, S. Ducasse, O. Nierstrasz | HTML |
...
| [Refactor Like a Superhero](https://github.com/bespoyasov/refactor-like-a-superhero-online-book/blob/main/manuscript-en/README.md) | Alex Bespoyasov | HTML |
| [Scrum and XP from the Trenches](https://www.infoq.com/minibooks/scrum-xp-from-the-trenches-2) | - | HTML |
| [Serverless apps: Architecture, patterns, and Azure implementation](https://docs.microsoft.com/en-us/dotnet/standard/serverless-architecture/) | - | HTML |
...
| [Site Reliability Engineering](https://landing.google.com/sre/book/index.html) | - | HTML |
...
| [Software Engineering for Internet Applications](https://philip.greenspun.com/seia/) | - | HTML |
| [Source Making Design Patterns and UML](https://sourcemaking.com/design_patterns) | - | HTML |
| [Test Driven Development, Extensive Tutorial](https://github.com/grzesiek-galezowski/tdd-ebook) | Grzegorz Gałęzowski | HTML |
| [The Catalog of Design Patterns](https://refactoring.guru/design-patterns/catalog) | - | HTML |
| [The Site Reliability Workbook](https://landing.google.com/sre/workbook/toc/) | Betsy Beyer, Niall Richard Murphy, David K. Rensin, Kent Kawahara, Stephen Thorne | HTML |
| [Web API Design](https://pages.apigee.com/rs/apigee/images/api-design-ebook-2012-03.pdf) | Brian Mulloy | PDF |
| [Working with Web APIs](https://launchschool.com/books/working_with_apis) | Launch School | HTML |
| [Your API Is Bad](https://leanpub.com/yourapiisbad/read) | Paddy Foran | HTML |
...
| Title | Author | Format |
| --- | --- | --- |
| [A git Primer](https://danielmiessler.com/study/git/) | Daniel Miessler | HTML |
| [A Visual Git Reference](https://marklodato.github.io/visual-git-guide/index-en.html) | Mark Lodato | HTML |
| [Conversational Git](https://blog.anvard.org/conversational-git/) | Alan Hohn | HTML |
...
| [Git for Computer Scientists](https://eagain.net/articles/git-for-computer-scientists/) | Tommi Virtanen | HTML |
| [Git From The Bottom Up](https://jwiegley.github.io/git-from-the-bottom-up/) | J. Wiegley | HTML |
| [Git Immersion](https://gitimmersion.com) | Jim Weirich | HTML |
| [Git In The Trenches](https://cbx33.github.io/gitt/index.html) | Peter Savage | HTML |
...
| [Git Pocket Guide](https://www.oreilly.com/library/view/git-pocket-guide/9781449327507) | Richard E. Silverman | HTML |
| [Git Reference](https://web.archive.org/web/20170602211147/http://gitref.org/) | The GitHub team  | HTML |
...
| [Git-Tutorial For-Beginners](https://product.hubspot.com/blog/git-and-github-tutorial-for-beginners) | HubSpot Product Team | HTML |
| [Git Workflows](https://web.archive.org/web/20210910133251/http://documentup.com/skwp/git-workflows-book) | Yan Pritzker  | HTML |
| [Happy Git and GitHub for the useR](https://happygitwithr.com) | Jenny Bryan | HTML |
| [Hg Init: a Mercurial Tutorial](https://hginit.github.io) | Joel Spolsky | HTML |
| [How to Collaborate on GitHub: A mini book about collaborating on GitHub](https://github.com/eonist/How-to-collaborate-on-github) | André J | HTML |
| [Introduction to Git and Github](https://launchschool.com/books/git) | Launch School | HTML |
...
| [Learn Git - Learn Version Control with Git](https://www.git-tower.com/learn/git/ebook/command-line/introduction) | Tobias Günther | HTML |
| [Mercurial: The Definitive Guide](http://hgbook.red-bean.com) | Bryan O'Sullivan | HTML |
| [Mercurial: The Definitive Guide 2nd edition](https://book.mercurial-scm.org) | Bryan O'Sullivan | HTML |
| [Pro Git](https://git-scm.com/book/en/) | Scott Chacon, Ben Straub | HTML, PDF, EPUB, Kindle |
| [Pro Git Reedited](https://leanpub.com/progitreedited/read) | Jon Forrest | HTML |
| [Ry's Git Tutorial](https://web.archive.org/web/20161121145226/http://rypress.com:80/tutorials/git/index) | Ryan Hodson | HTML |
| [Subversion Version Control](https://ptgmedia.pearsoncmg.com/images/0131855182/downloads/Nagel_book.pdf) | William Nagel | PDF |
| [Think Like (a) Git: A Guide for the Perplexed](https://think-like-a-git.net) | Sam Livingston-Gray | HTML |
...
Although I took the time to collect the links, data, and gather everything together in a single place (_quite a hellish experience, I must say_), all the content belongs to their respective authors. However, and as I believe these days are the brightest for learners, I tried my best to offer free-access content so that no one has to stay behind due to economic reasons.
